...
- For every pie after the second, the DC increases by 2. 
...
- **Plating relies on Charisma or Constitution.** The PC(s) assigned to plate the food must plate the food quickly, so it’s still warm, without compromising its structural integrity. The meal ought to look appetizing! This role also involves taste-testing the food. So, if there’s any, er, hazards, they’re the first line of defense.
